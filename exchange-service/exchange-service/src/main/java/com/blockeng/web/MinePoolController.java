...
import com.blockeng.dto.CreateMinePoolDTO;
import com.blockeng.entity.MinePool;
...
import com.blockeng.service.MinePoolService;
...
public class MinePoolController {
    ...
    public Response create(@RequestBody @Valid CreateMinePoolDTO createMinePoolDTO,
        ...
        if (minePool != null) {
            // 您已经创建了一个矿池
            throw new GlobalDefaultException(50030);
        }
