...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COMMENT='系统菜单';
...
) ENGINE=InnoDB AUTO_INCREMENT=1010101010101010199 DEFAULT CHARSET=utf8mb4 COMMENT='权限配置';
...
CREATE TABLE `sys_role` (
  ...
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016200921405169667 DEFAULT CHARSET=utf8mb4 COMMENT='角色';
...
CREATE TABLE `sys_role_menu` (
  ...
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016202328241840132 DEFAULT CHARSET=utf8mb4 COMMENT='角色菜单';
...
CREATE TABLE `sys_role_privilege` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016202327952433158 DEFAULT CHARSET=utf8mb4 COMMENT='角色权限配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=1010101010101010228 DEFAULT CHARSET=utf8mb4 COMMENT='用户权限配置';
...
CREATE TABLE `sys_user` (
  ...
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016501904190447618 DEFAULT CHARSET=utf8mb4 COMMENT='平台用户';
...
CREATE TABLE `sys_user_role` (
  ...
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016502740303978498 DEFAULT CHARSET=utf8mb4 COMMENT='用户角色配置';
