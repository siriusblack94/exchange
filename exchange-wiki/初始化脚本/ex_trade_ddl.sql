...
CREATE TABLE `account` (
  ...
  `balance_amount` decimal(30,8) NOT NULL COMMENT '币种可用金额',
  `freeze_amount` decimal(30,8) NOT NULL COMMENT '币种冻结金额',
  `recharge_amount` decimal(30,8) NOT NULL COMMENT '累计充值金额',
  `withdrawals_amount` decimal(30,8) NOT NULL COMMENT '累计提现金额',
  `net_value` decimal(30,8) NOT NULL COMMENT '净值',
  `lock_margin` decimal(30,8) NOT NULL COMMENT '占用保证金',
  `float_profit` decimal(30,8) NOT NULL COMMENT '持仓盈亏/浮动盈亏',
  `total_profit` decimal(30,8) NOT NULL COMMENT '总盈亏',
...
) ENGINE=InnoDB AUTO_INCREMENT=1017411061713821700 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资金账户';
...
CREATE TABLE `account_copy1` (
  ...
  KEY `account_coin_id_ref` (`coin_id`) USING BTREE,
  KEY `inx_platform_account` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017154683489312772 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资金账户';
...
CREATE TABLE `account_cz_wushan_1` (
  ...
  KEY `account_coin_id_ref` (`coin_id`) USING BTREE,
  KEY `inx_platform_account` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015536651365109762 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资金账户';
...
CREATE TABLE `account_detail` (
  ...
  `amount` decimal(20,8) NOT NULL COMMENT '数量/金额',
...
) ENGINE=InnoDB AUTO_INCREMENT=1017408561821118867 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='资金账户流水';
...
CREATE TABLE `account_detail_lcp` (
  ...
  KEY `payment_detail_refaccountid_fk` (`ref_account_id`) USING BTREE,
  KEY `fk_accountdetail_coinid` (`coin_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015545041202329674 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='资金账户流水';
...
CREATE TABLE `account_detail_old` (
  ...
  KEY `payment_detail_refaccountid_fk` (`ref_account_id`) USING BTREE,
  KEY `fk_accountdetail_coinid` (`coin_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015613156212763233 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='资金账户流水';
...
CREATE TABLE `account_old` (
  ...
  KEY `account_coin_id_ref` (`coin_id`) USING BTREE,
  KEY `inx_platform_account` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015624599108800515 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资金账户';
...
CREATE TABLE `admin_bank` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015620813971660803 DEFAULT CHARSET=utf8mb4 COMMENT='人民币充值卡号管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=1017327057459630082 DEFAULT CHARSET=utf8mb4 COMMENT='法币充值记录';
...
CREATE TABLE `cash_recharge_audit_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='法币充值审核记录';
...
CREATE TABLE `cash_withdraw_audit_record` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='法币提现审核记录';
...
CREATE TABLE `cash_withdrawals` (
  ...
  KEY `userid` (`user_id`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='法币提现记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=1016312636281167874 DEFAULT CHARSET=utf8mb4 COMMENT='币种配置信息';
...
CREATE TABLE `coin_recharge` (
  ...
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='数字货币充值记录';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='数字货币提现记录';
...
CREATE TABLE `coin_withdraw_audit_record` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='数字货币提现审核记录';
...
CREATE TABLE `entrust_order` (
  ...
  `merge_low_price` decimal(20,8) DEFAULT NULL COMMENT '合并深度价格1',
  `merge_high_price` decimal(20,8) DEFAULT NULL COMMENT '合并深度价格2',
  `volume` decimal(20,8) NOT NULL COMMENT '委托数量',
  `amount` decimal(20,8) NOT NULL COMMENT '委托总额',
  `fee_rate` decimal(20,8) NOT NULL COMMENT '手续费比率',
  `fee` decimal(20,8) NOT NULL COMMENT '交易手续费',
  `contract_unit` int(11) DEFAULT NULL COMMENT '合约单位',
  `deal` decimal(20,8) NOT NULL COMMENT '成交数量',
  `freeze` decimal(20,8) NOT NULL COMMENT '冻结量',
  `margin_rate` decimal(20,8) DEFAULT NULL COMMENT '保证金比例',
  `base_coin_rate` decimal(20,8) DEFAULT NULL COMMENT '基础货币对（USDT/BTC）兑换率',
  `price_coin_rate` decimal(20,8) DEFAULT NULL COMMENT '报价货币对（USDT/BTC)兑换率',
  `lock_margin` decimal(20,8) DEFAULT NULL COMMENT '占用保证金',
  `price_type` tinyint(4) NOT NULL DEFAULT '2' COMMENT '价格类型：1-市价；2-限价',
  `trade_type` tinyint(4) DEFAULT NULL COMMENT '交易类型：1-开仓；2-平仓',
  `type` tinyint(1) NOT NULL COMMENT '买卖类型：1-买入；2-卖出',
  `open_order_id` bigint(18) DEFAULT NULL COMMENT '平仓委托关联单号',
  `status` tinyint(1) NOT NULL COMMENT 'status：0-未成交；1-已成交；2-已取消；3-异常单',
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017429408232857603 DEFAULT CHARSET=utf8mb4 COMMENT='委托订单信息';
...
CREATE TABLE `entrust_order_copy1` (
  ...
  KEY `idx_user_id` (`user_id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017134781131280386 DEFAULT CHARSET=utf8mb4 COMMENT='委托订单信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=1015427013835890691 DEFAULT CHARSET=utf8mb4 COMMENT='交易对配置信息';
...
CREATE TABLE `notice` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016920393086623746 DEFAULT CHARSET=utf8mb4 COMMENT='系统资讯公告信息';
...
CREATE TABLE `sms` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017427499895840771 DEFAULT CHARSET=utf8mb4 COMMENT='短信信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=1015426106142367746 DEFAULT CHARSET=utf8mb4 COMMENT='交易区';
...
CREATE TABLE `turnover_order` (
  ...
  `sell_price` decimal(20,8) NOT NULL COMMENT '卖方委托价格',
  `sell_fee_rate` decimal(20,8) NOT NULL COMMENT '卖方手续费率',
  `sell_volume` decimal(20,8) NOT NULL COMMENT '卖方委托数量',
  `buy_user_id` bigint(18) NOT NULL COMMENT '买方用户ID',
  `buy_coin_id` bigint(18) NOT NULL COMMENT '买方币种ID',
  `buy_order_id` bigint(18) NOT NULL COMMENT '买方委托订单ID',
  `buy_volume` decimal(20,8) NOT NULL COMMENT '买方委托数量',
  `buy_price` decimal(20,8) NOT NULL COMMENT '买方委托价格',
  `buy_fee_rate` decimal(20,8) NOT NULL COMMENT '买方手续费率',
  `order_id` bigint(18) NOT NULL COMMENT '委托订单ID',
  `amount` decimal(20,8) NOT NULL COMMENT '成交总额',
  `price` decimal(20,8) NOT NULL COMMENT '成交价格',
  `volume` decimal(20,8) NOT NULL COMMENT '成交数量',
  `deal_sell_fee` decimal(20,8) NOT NULL COMMENT '成交卖出手续费',
  `deal_sell_fee_rate` decimal(20,8) NOT NULL COMMENT '成交卖出手续费率',
  `deal_buy_fee` decimal(20,8) NOT NULL COMMENT '成交买入手续费',
  `deal_buy_fee_rate` decimal(20,8) NOT NULL COMMENT '成交买入成交率费',
...
) ENGINE=InnoDB AUTO_INCREMENT=1016739662108707976 DEFAULT CHARSET=utf8mb4 COMMENT='成交订单';
...
CREATE TABLE `user` (
  ...
  `invite_relation` varchar(256) DEFAULT NULL COMMENT '邀请关系',
...
) ENGINE=InnoDB AUTO_INCREMENT=1017411061685235715 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';
...
CREATE TABLE `user_auth_audit_record` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017403712760463362 DEFAULT CHARSET=utf8mb4 COMMENT='实名认证审核信息';
...
CREATE TABLE `user_auth_info` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017403712777240579 DEFAULT CHARSET=utf8mb4 COMMENT='实名认证信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=1010101010101010130 DEFAULT CHARSET=utf8mb4 COMMENT='用户绑卡信息';
...
CREATE TABLE `user_cz_0709` (
  ...
  KEY `idx_addtime` (`created`) USING BTREE,
  KEY `username` (`username`(191)) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016257028458749955 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';
...
CREATE TABLE `user_cz_wushan_bak` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态：0，禁用；1，启用；',
  `invite_code` varchar(200) DEFAULT NULL COMMENT '邀请码',
  `invite_relation` text COMMENT '邀请关系',
  `direct_inviteid` text COMMENT '直接邀请人ID',
  `is_deductible` int(11) DEFAULT '0' COMMENT '0 否 1是  是否开启平台币抵扣手续费',
  `reviews_status` int(11) DEFAULT '0' COMMENT '审核状态,1通过,2拒绝,0,待审核',
  `agent_note` text COMMENT '代理商拒绝原因',
  `access_key_id` varchar(16) DEFAULT NULL COMMENT 'API的KEY',
  ...
  KEY `idx_addtime` (`created`) USING BTREE,
  KEY `username` (`username`(191)) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015536651323853236 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';
...
CREATE TABLE `user_old` (
  ...
  KEY `idx_addtime` (`created`) USING BTREE,
  KEY `username` (`username`(191)) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1015624599058100227 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1017304057515171842 DEFAULT CHARSET=utf8mb4 COMMENT='用户提币地址';
...
CREATE TABLE `web_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1016153840237912066 DEFAULT CHARSET=utf8mb4 COMMENT='网站配置信息';
...
CREATE TABLE `work_issue` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1010101010101010106 DEFAULT CHARSET=utf8mb4 COMMENT='工单记录';
