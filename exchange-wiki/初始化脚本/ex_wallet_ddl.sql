...
) ENGINE=InnoDB AUTO_INCREMENT=120001 DEFAULT CHARSET=utf8mb4 COMMENT='钱包地址池';
...
CREATE TABLE `coin_recharge` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017374322571513859 DEFAULT CHARSET=utf8mb4 COMMENT='数字货币充值记录';
...
CREATE TABLE `user_address` (
  ...
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `USERETH_UID_COINID_INX` (`user_id`,`coin_id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=1017340447333978114 DEFAULT CHARSET=utf8mb4 COMMENT='用户钱包地址信息';
...
CREATE TABLE `wallet_collect_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1017374322613456898 DEFAULT CHARSET=utf8mb4 COMMENT='钱包归集任务';
