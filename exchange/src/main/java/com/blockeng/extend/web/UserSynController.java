...
public class UserSynController {
     ...
     */
    @PostMapping("/logout")
    public Object logout(UserSyn user){
      ...
      //退出CONFIG
        ...
        ResponseEntity<Object> exchange = restTemplate.exchange(configLogout.getValue(), HttpMethod.GET, request, Object.class);
    ...
    public void userInfoSyn() {
        ...
        List<UserSynExecption> users = userSynExceptionService.selectList(new QueryWrapper<UserSynExecption>());
